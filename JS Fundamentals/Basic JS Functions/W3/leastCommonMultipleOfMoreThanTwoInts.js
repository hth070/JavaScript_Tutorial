function leastCommonMultipleOfMoreThanTwoInts(input_array) {
...
console.log(leastCommonMultipleOfMoreThanTwoInts([100,90,80,7])); 
console.log(leastCommonMultipleOfMoreThanTwoInts([5,10,15,25]));